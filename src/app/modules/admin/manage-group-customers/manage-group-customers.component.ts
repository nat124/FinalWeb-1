...
searchData=""
  ...
  Search(){
debugger
 var filterdata=this.dataList.filter(x=>x.User.Email.includes(this.searchData))
 ...
 this.dataList = filterdata
  ...
  filterGroupCustomerswithName(Id: number,searchData:string) {
    return this.http.get(this.url + 'CustomerGroup/filterGroupCustomerswithName?Id=' + Id+'&name='+searchData)
  }
  onDelete(Id: number) {
