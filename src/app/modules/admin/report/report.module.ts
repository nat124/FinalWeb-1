...
import { ChatReportComponent } from './chat/chat.component';


@NgModule({
  declarations: [MostViewedComponent, BestSellerComponent, LowStockComponent, ChatReportComponent],
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'Chat-Report', component: ChatReportComponent },
    ]),
