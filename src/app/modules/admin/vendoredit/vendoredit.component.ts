...
debugger
    ...
    if(form.value.Company=="" || form.value.Company==null){
      this.companyy=true
      //return false
    }else{
      this.companyy=false
    ...
    if(form.value.DisplayName=="" || form.value.DisplayName==null ){
      this.DisName=true
      //return false
    }else{
      this.DisName=false
  ...
  if(form.value.CountryId==0|| form.value.CountryId==null){
  ...
  if(form.value.StateId==0 || form.value.StateId==null){
  ...
  if( form.value.GenderId==0 || form.value.GenderId==null){
    this.Genderval=true
    //return false
  }else{
  ...
  if( form.value.LanguageId==0 || form.value.LanguageId==null){
