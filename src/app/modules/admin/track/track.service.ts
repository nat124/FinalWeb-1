...
export class TrackService {
  ...
  filterUserweb(){
    return this.http.get(this.baseuri+'UserLog/filterUserweb')
  }
  enable()
  {
  ...
  GetEnable()
  {
    return this.http.get(this.baseuri+'UserLog/GetEnable')
  ...
  ErrorsMObileTacking(){
    return this.http.get(this.baseuri+'UserLog/ErrorsMObileTacking')

  }

  getFilterHomeAcrions(PageName,date:any="",UserId=0){

    return this.http.get(this.baseuri+'newdash/getFilterHomeAcrions?PageName='+PageName+"&UserId="+UserId+"&date="+date)
