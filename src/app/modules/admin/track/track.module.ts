...
//import { TrackDhashboardComponent } from '../../logs-dhashboard/track-dhashboard/track-dhashboard.component';
import { DashboardComponent } from '../dashboard/dashboard.component';
import { TabModule } from '@syncfusion/ej2-angular-navigations';
import { ErrorsComponent } from './errors/errors.component';
//import { DashboardMobileComponent } from '../../logs-dhashboard/dashboard-mobile/dashboard-mobile.component';
// import { LiveTrafficComponent } from '../../live-dhashboard/live-traffic/live-traffic.component';//
//import { UserLiveComponent } from '../../live-dhashboard/user-live/user-live.component';
//import { OrderLiveComponent } from../../live-dhashboard/order-live/order-live.componentnt';
import { SalesLiveComponent } from './sales-live/sales-live.component';
import { ErrorMobileComponent } from './error-mobile/error-mobile.component';
...
const routes: Routes = [
  ...
  {path:"errorMobile" ,component: ErrorMobileComponent},
     ...
     TrackMyprofileComponent,
      CustomerLoginComponent,
       ...
       AllNotificationComponent,
        ...
        AllReviewsComponent,
        ConfirmOrderComponent, CustomerRegComponent, MyOrdersComponent, ErrorsComponent, SalesLiveComponent, ErrorMobileComponent],
  imports: [
    CommonModule,
