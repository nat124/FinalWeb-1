...
import { PistisEventNotiComponent } from './pistis-event-noti/pistis-event-noti.component';
import { PistisNotiListComponent } from './pistis-noti-list/pistis-noti-list.component';
...
const routes: Routes = [
  ...
  { path: "PistisEvNoti", component: PistisEventNotiComponent },
...
{path: 'Vendoredit', component: VendoreditComponent},
    ...
    { path: "PayConfig", component: PaymentConfigComponent },
    { path: "ChatReport", component: ChatReportComponent },
...
BannerUploadComponent,
    ...
    PistisEventNotiComponent,
    PistisNotiListComponent,
    ChatComponent,CheckoutComponent
