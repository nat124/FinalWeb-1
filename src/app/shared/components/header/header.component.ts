...
$("#menuId").removeClass('hide')
  ...
  wishlist(){
    ...
    this.tracklog.handleSuccess1(this.description="Clicked on my wishlist",this.Action="wishlist","Request",this.RequestUrl,this.PageUrl,this.Guid)
  ...
  getDealId(dealId:number){
    this.RequestUrl='/dealscatalogue'
    this.tracklog.handleSuccess1(this.description="Clicked on deals",this.Action="deals","Request",this.RequestUrl,this.PageUrl,this.Guid)
