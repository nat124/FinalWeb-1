...
this.tracklog.handleSuccess1(this.myViewModel.description="change picture of product",this.myViewModel.Action="Picture change","x",this.RequestUrl,this.PageUrl,this.Guid)
