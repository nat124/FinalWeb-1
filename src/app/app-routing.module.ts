...
{ path: '', loadChildren: 'src/app/shared/components/checkout/checkout.module#CheckoutModule' }]},
  {
    ...
    {
      path: "live", component: LiveReportlayoutComponent,
      children: [
        {
          path: "", loadChildren: 'src/app/modules/live-dhashboard/live-dhashboard.module#liveModule'
        },
      ]},
      {
        path: "logs", component: LogslayoutComponent,
        children: [
          {
            path: "", loadChildren: 'src/app/modules/logs-dhashboard/logs.module#LogsModule'
          },
        ]},
  {
